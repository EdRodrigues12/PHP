<?php
	include("../inc/conexao.php");
		 if ($_GET['Funcao'] == "lancar"){
		 	...
		 	$SQLalterar ="INSERT INTO `bdcadastroetec`.`tbmencao` ( `Mencaoparcial`,`Nome`, `Turma`, `Turno`, `Disciplina`) VALUES ( '".$_POST['mencao']."', '".$_POST['Nome']."', '".$_POST['Turma']."', '".$_POST['Turno']."', '".$_POST['Disciplinas']."');";
...
<html>
<head>
	<title>Lançar Mençoes</title>
	<link rel= "stylesheet" type="text/css" href="../css/style.css">
		
</head>
<body>
<form Name="lancamencoes" method="Post" action="lancamencoes.php?Funcao=pesquisar">
	<fieldset>
		<br>
		...
		<br>
			...
			<?php
				include("../inc/conexao.php");
					...
					<form Name="lancamencoes" method="POST" action ="lancamencoes.php?Funcao=lancar">	
					...
					<label for="Name"> Selecionar Menção Parcial: </label>
